...
namespace SWP391.Controllers
{
    ...
    public class PhotosController : ControllerBase
    {
        ...
        // GET: api/Photos/test-connection
        ...
        public async Task<ActionResult<string>> TestConnection()
        {
            try
            {
                ...
                // Kiểm tra xem bảng ProductImages có tồn tại không
                ...
                using (var connection = new SqlConnection(connectionString))
                {
                    ...
                    var sql = @"
                        ...
                        WHERE TABLE_NAME LIKE '%ProductImage%'";
            ...
            {
                return StatusCode(500, $"Lỗi khi kiểm tra kết nối: {ex.Message}");
            }
        }
